...
|------------------------------------------------------|-----------------------------------------------------------------------|
| [`public`](../../../README.md#public-string)                           | Set a sub directory to be served                                      |
| [`cleanUrls`](../../../README.md#cleanurls-booleanarray)               | Have the `.html` extension stripped from paths                        |
| [`rewrites`](../../../README.md#rewrites-array)                        | Rewrite paths to different paths                                      |
| [`redirects`](../../../README.md#redirects-array)                      | Forward paths to different paths or external URLs                     |
| [`headers`](../../../README.md#headers-array)                          | Set custom headers for specific paths                                 |
| [`directoryListing`](../../../README.md#directorylisting-booleanarray) | Disable directory listing or restrict it to certain paths             |
| [`unlisted`](../../../README.md#unlisted-array)                        | Exclude paths from the directory listing                              |
| [`trailingSlash`](../../../README.md#trailingslash-boolean)            | Remove or add trailing slashes to all paths                           |
| [`renderSingle`](../../../README.md#rendersingle-boolean)              | If a directory only contains one file, render it                      |
| [`symlinks`](../../../README.md#symlinks-boolean)                      | Resolve symlinks instead of rendering a 404 error                     |
| [`etag`](../../../README.md#etag-boolean)                              | Calculate a strong `ETag` response header, instead of `Last-Modified` |
...
Just like with [rewrites](../../../README.md#rewrites-array), you can also use routing segments:
...
Either you disable the directory listing entirely (like shown [here](../../../README.md#directorylisting-booleanarray)), or you exclude certain paths from those listings by adding them all to this config property.
...
Sometimes you might want to have a directory path actually render a file, if the directory only contains one. This is only useful for any files that are not `.html` files (for those, [`cleanUrls`](../../../README.md#cleanurls-booleanarray) is faster).
