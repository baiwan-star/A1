...
- [Basic Usage](../../../README.md#basic-usage)
  - [In the Browser](../../../README.md#in-the-browser)
    - [Plaintext Code Blocks](../../../README.md#plaintext-code-blocks)
    - [Ignoring a Code Block](../../../README.md#ignoring-a-code-block)
  - [Node.js on the Server](../../../README.md#nodejs-on-the-server)
- [Supported Languages](../../../README.md#supported-languages)
- [Custom Usage](../../../README.md#custom-usage)
  - [Using custom HTML](../../../README.md#using-custom-html)
  - [Using with Vue.js](../../../README.md#using-with-vuejs)
  - [Using Web Workers](../../../README.md#using-web-workers)
- [Importing the Library](../../../README.md#importing-the-library)
  - [Node.js CommonJS Modules / `require`](../../../README.md#nodejs-commonjs-modules--require)
  - [Node.js ES6 Modules / `import`](../../../README.md#nodejs-es6-modules--import)
  - [Browser ES6 Modules](../../../README.md#browser-es6-modules)
- [Getting the Library](../../../README.md#getting-the-library)
  - [Fetch via CDN](../../../README.md#fetch-via-cdn)
    - [cdnjs (link)](../../../README.md#cdnjs-link)
    - [jsdelivr (link)](../../../README.md#jsdelivr-link)
    - [unpkg (link)](../../../README.md#unpkg-link)
  - [Download prebuilt CDN assets](../../../README.md#download-prebuilt-cdn-assets)
  - [Download from our website](../../../README.md#download-from-our-website)
  - [Install via NPM package](../../../README.md#install-via-npm-package)
...
See [Importing the Library](../../../README.md#importing-the-library) for more examples of `require` vs `import` usage, etc.  For more information about the result object returned by `highlight` or `highlightAuto` refer to the [api docs](https://highlightjs.readthedocs.io/en/latest/api.html).
...
First, you'll likely be installing the library via `npm` or `yarn` -- see [Getting the Library](../../../README.md#getting-the-library).
...
See [Download prebuilt CDN assets](../../../README.md#download-prebuilt-cdn-assets)*
...
*Note: You can also import directly from fully static URLs, such as our very own pre-built ES6 Module CDN resources. See [Fetch via CDN](../../../README.md#fetch-via-cdn) for specific examples.*
...
**Note:** [Building from source](../../../README.md#build-from-source) can produce slightly smaller builds than the website download.
...
There is also another npm package [@highlightjs/cdn-assets](https://www.npmjs.com/package/@highlightjs/cdn-assets) that contains prebuilt CDN assets including [ES6 Modules that can be imported in browser](../../../README.md#browser-es6-modules):
