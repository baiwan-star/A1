...
> Tip: You can still skip a task while already executing the `task` function with the [task object](../../../README.md#task-object).
...
Skip function. Read more about [skipping tasks](../../../README.md#skipping-tasks).
