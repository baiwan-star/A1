...
**Note** — If your schema uses certain asynchronous APIs like `async` [refinements](../../../README.md#refine) or [transforms](../../../README.md#transform), you'll need to use the `.parseAsync()` method instead.
...
**Note** — If your schema uses certain asynchronous APIs like `async` [refinements](../../../README.md#refine) or [transforms](../../../README.md#transform), you'll need to use the `.safeParseAsync()` method instead.
